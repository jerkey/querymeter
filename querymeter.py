...
if __name__ == '__main__':
    send_break()
    print('sent message 0: ' + bytes(send_message([0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x09])).hex()) # necessary
    time.sleep(0.220)
    send_break()
    ...
    #time.sleep(5.13)
    #send_break()
    #print('sent message 7: ' + bytes(send_message(meter_id + [0x03,  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x22,0x01,0x00,0x00,0x74])).hex())
    #wait_for_response()
    #time.sleep(0.1)
    send_break()
    #print('sent message 5: ' + bytes(send_message(meter_id + [0x05,  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,  0xA7,0x23,0xB1,0xC1,0xE9,0x4D,0xA6,0x8C])).hex())
    print('sent kwh query: ' + bytes(send_message(meter_id + [0x01,0x18])).hex())
    r = wait_for_response()
